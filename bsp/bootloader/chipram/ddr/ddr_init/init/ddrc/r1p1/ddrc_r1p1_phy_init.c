...
static u32 trfc_dtmg2[8] = {0x3019,0x4825,0x7e40,0x9149,0xC262,0xFD7F,0xFF92,0xFFB2};
...
void ddrc_phy_pin_mux_setting(void)
{
	...
	{
		reg_bits_set(DMC_GUCPHY0_BASE + 0xcb*4, 24, 8, 0x41);//32c
		__raw_writel(DMC_GUCPHY0_BASE + 0xcc*4, 0x86107324);//330
		__raw_writel(DMC_GUCPHY0_BASE + 0xcd*4, 0x50832715);//334
		__raw_writel(DMC_GUCPHY0_BASE + 0xce*4, 0x1AC68846);//338
		__raw_writel(DMC_GUCPHY0_BASE + 0xcf*4, 0x76235041);//33c
		reg_bits_set(DMC_GUCPHY0_BASE + 0xd1*4, 12, 4, 0x1);
		__raw_writel(DMC_GUCPHY0_BASE + 0xd4*4, 0x36802154);//350
		__raw_writel(DMC_GUCPHY0_BASE + 0xd5*4, 0x76832057);//354
